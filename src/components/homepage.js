import { Card, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow } from "@material-ui/core";
            ...
            <Card className={classes.root}>
                ...
                <TableContainer className={classes.container}>
                    <Table stickyHeader aria-label="sticky table">
                        <TableHead>
                            <TableRow>
                                <TableCell align="center" style={{ minWidth: 150 }}>Image</TableCell>
                                <TableCell align="center" style={{ minWidth: 150 }}>Title</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
